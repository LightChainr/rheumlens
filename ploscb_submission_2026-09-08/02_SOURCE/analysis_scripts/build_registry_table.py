#!/usr/bin/env python3
"""Generate the cohort registry (Table S8) from the registry file and the donor tables.

The released Table S8 had been maintained by hand, had drifted out of column
...
OUT = ROOT / "supplementary" / "Table_S8_cohort_registry.tsv"
