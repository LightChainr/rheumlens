...
CHECKS: list[tuple[str, str]] = [
    ...
    ("CMV all AUC",            r("CMV_HIHA", "all", "design_auc_frozen").replace("-", " to ")),
    ("CMV collection AUC",     r("CMV_HIHA", "batch", "design_auc_frozen").replace("-", " to ")),
    ("CMV quality AUC",        r("CMV_HIHA", "qc", "design_auc_frozen").replace("-", " to ")),
    ("CMV demographic AUC",    r("CMV_HIHA", "demographic", "design_auc_frozen").replace("-", " to ")),
    ("CMV diagnosis AUC",      r("CMV_HIHA", "all", "observed_frozen_auc").replace("-", " to ")),
    ("Stephenson all AUC",     r("COVID_STEPHENSON", "all", "design_auc_frozen")),
    ("Stephenson quality AUC", r("COVID_STEPHENSON", "qc", "design_auc_frozen")),
    ("Stephenson coll AUC",    r("COVID_STEPHENSON", "batch", "design_auc_frozen")),
    ("Ren all AUC",            r("COVID_REN", "all", "design_auc_frozen")),
    ("Ren collection AUC",     r("COVID_REN", "batch", "design_auc_frozen")),
    ("Ren quality AUC",        r("COVID_REN", "qc", "design_auc_frozen")),
    ("COMBAT_COVID all AUC",   r("COMBAT_COVID", "all", "design_auc_frozen")),
    ("Cross all AUC",          r("COMBAT_CROSS", "all", "design_auc_frozen").replace("-", " to ")),
