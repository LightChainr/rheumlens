#!/usr/bin/env python3
"""Write Table S8 from the pipeline objects that actually ran.
...
from its description without this script changing what it prints.
    ...
    python3 tools/build_hyperparameter_table.py [--out supplementary/Table_S8_hyperparameters.tsv]
"""
...
def main() -> None:
    ...
    out = Path(args.out)
    header = (
        "# Table S8. Every fitted pipeline in the paper, and its settings.\n"
