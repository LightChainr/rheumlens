...
Writes:
  ...
  supplementary/Table_S8_seed_stability.tsv
"""
...
if bad:
    raise SystemExit(f"Table S8 still uses retired names: {bad}")
seed_pub.to_csv(ROOT / "supplementary/Table_S8_seed_stability.tsv",
                sep="\t", index=False)
...
print("wrote data/*.tsv and supplementary/Table_S4_full_screen.tsv, Table_S8_seed_stability.tsv")
