...
SOURCE = ROOT / "RheumLens_manuscript_working_v0.3.md"
OUTPUT = ROOT / "RheumLens_manuscript_working_v0.3.docx"

TITLE = (
    "Leakage-resistant donor-level benchmarking reveals reproducible SLE signals "
    "but no advantage of frozen scGPT over expression baselines"
)
...
def configure_styles(doc):
    ...
    set_font(header.add_run("RheumLens | Working manuscript v0.3"), size=9, color=MUTED)
...
def build():
    ...
    set_font(meta.add_run("Working draft v0.3 · 19 June 2026 · Target: Bioinformatics Advances"), size=10, italic=True, color=MUTED)
    ...
    set_font(p.add_run("Fold-contained reanalysis, HVG-pseudobulk baseline and paired donor-bootstrap confidence intervals are complete. Author metadata, repository links, figure regeneration and reference audit remain pending."), size=9.5)
