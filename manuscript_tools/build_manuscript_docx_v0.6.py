...
SOURCE = ROOT / "RheumLens_manuscript_working_v0.6.md"
OUTPUT = ROOT / "RheumLens_manuscript_working_v0.6.docx"
...
def configure_styles(doc):
    ...
    set_font(header.add_run("RheumLens | Working manuscript v0.6"), size=9, color=MUTED)
...
def build():
    ...
    set_font(meta.add_run("Working draft v0.6 · 23 June 2026 · Target journal to be selected"), size=10, italic=True, color=MUTED)
